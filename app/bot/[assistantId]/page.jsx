...
import { useParams } from 'next/navigation';  // Import this for dynamic params
...
const VapiChatbot = () => {
  ...
  const assistantId = params.assistantId;  // This is now from the path, e.g., /bot/{assistantId}
